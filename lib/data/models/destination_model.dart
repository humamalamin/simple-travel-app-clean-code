...
class DestinationModel extends DestinationEntity{
  ...
  Map<String, dynamic> toJson() => {
    ...
    DestinationEntity get toEntity => DestinationEntity(id: id, name: name, category: category, cover: cover, rate: rate, rateCount: rateCount, location: location, description: description, images: images, facilities: facilities);
}